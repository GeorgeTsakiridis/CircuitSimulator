package eu.gtsak.circuitsimulator.settings;
...
public class Settings {
    ...
    public static void save() throws IOException {
        ...
        dataOutputStream.writeLong(CircuitSimulator.MAGIC_NUMBER_CONF_SAVE);
    ...
    public static void load() throws IOException {
        ...
        if (configFile.exists()) {
            ...
            if (!magicNumber.equals(CircuitSimulator.MAGIC_NUMBER_CONF_SAVE)) {
