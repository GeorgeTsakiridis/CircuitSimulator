...
import eu.gtsak.circuitsimulator.logic.CSActionsManager;
...
public class Window {
    ...
    private final JMenu projectMenu = new JMenu(Localization.getString("project"));
    private final JMenu viewMenu = new JMenu(Localization.getString("view"));
    private final JMenu linesViewSubMenu = new JMenu(Localization.getString("lines"));
    private final JMenu pinsViewSubMenu = new JMenu(Localization.getString("pins"));
    private final JMenu simulationMenu = new JMenu(Localization.getString("simulation"));
    private final JMenu helpMenu = new JMenu(Localization.getString("help"));
    ...
    public Window(Handler handler, ViewportPanel viewportPanel, ComponentInfoPanel componentInfoPanel){
        ...
        AbstractAction saveProjectAction = new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
        ...
        AbstractAction loadProjectAction = new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (getValidation()) {
                    try {
        ...
        AbstractAction mouseGridSnapModeAction = new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        AbstractAction chipNameToggleAction = new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        AbstractAction gridToggleAction = new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        AbstractAction showComponentInfoWindowAction = new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        JMenuItem versionMenuItem = new JMenuItem(Localization.getString("version") + ": " + CircuitSimulator.PROGRAM_VERSION_STRING + " (" + Localization.getString("build") + " " + CircuitSimulator.PROGRAM_VERSION + ")");
...
/*
    private final AbstractAction helpAction = new AbstractAction() {
        @Override
        public void actionPerformed(ActionEvent e) {
